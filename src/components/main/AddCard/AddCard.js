...
export default (props) => {
  ...
  return (
    <div className="container">
      <h1 className="text-center py-4">Add card</h1>
        ...
        <div className="col-md-6 d-flex justify-content-center">
          <form onSubmit={onSaveHandler} className="w-100">
            <div className="form-group">
              ...
              <input ref={name} required onChange={onChangeHandler} name="name" type="text" className="form-control form-control-lg" id="name" placeholder="Enter your name"></input>
            </div>
            ...
            <div className="form-group">
              ...
              <input ref={date} required onChange={onChangeHandler} name="date" type="date" className="form-control form-control-lg" id="name" placeholder="Enter date"></input>
            </div>
            {
              showDateError &&
              <div class="alert alert-danger" role="alert">
